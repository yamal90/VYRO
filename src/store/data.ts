...
export const GPU_DEVICES: GPUDevice[] = [
  { id: 'gpu-1', name: 'Intel Core i3-12100', description: 'GTX 1650 | 8GB RAM', price: 80, reward_3_days: 4.80, reward_7_days: 11.20, compute_power: 4, active: true, image_url: '/images/gpu-x120.jpg?v=20260501' },
  { id: 'gpu-2', name: 'Intel Core i5-12400F', description: 'GTX 1660 Super | 16GB RAM', price: 160, reward_3_days: 9.60, reward_7_days: 22.40, compute_power: 8, active: true, image_url: '/images/gpu-g88.jpg?v=20260501' },
  { id: 'gpu-3', name: 'AMD Ryzen 5 5600', description: 'RTX 3050 | 16GB RAM', price: 480, reward_3_days: 28.80, reward_7_days: 67.20, compute_power: 24, active: true, image_url: '/images/gpu-g100.jpg?v=20260501' },
  { id: 'gpu-4', name: 'Intel Core i5-13400F', description: 'RTX 3060 | 16GB RAM', price: 1200, reward_3_days: 72.00, reward_7_days: 168.00, compute_power: 68, active: true, image_url: '/images/gpu-g700.jpg?v=20260501' },
